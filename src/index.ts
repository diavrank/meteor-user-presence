...
const createIndex = async (collection: Mongo.Collection<any>, index: IndexSpecification, options?: CreateIndexesOptions) => {
...
Accounts.onLogin(({ connection, user }: { connection: Meteor.Connection, user: Meteor.User }) => {
